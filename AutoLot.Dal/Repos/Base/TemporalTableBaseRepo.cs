...
where T : BaseEntity, new()
{
    ...
    // The next method takes in an IQueryable<T>, adds the OrderBy clause for the ValidFrom field, and
    // projects the results into a collection of TemporalViewModel instances:
    ...
    => ExecuteQuery(Table.TemporalBetween(ConvertToUtc(startDateTime),
